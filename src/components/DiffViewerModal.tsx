...
export const DiffViewerModal: React.FC<DiffViewerModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
      <div className="relative w-full max-w-4xl h-[85vh] bg-zinc-950 border border-zinc-800 rounded-2xl shadow-2xl flex flex-col overflow-hidden">
        {/* Header */}
          ...
          <div className="flex items-center gap-2">
            ...
            {onApplyNewCode && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-purple-600 hover:bg-purple-500 text-white text-xs font-medium transition-colors shadow-md shadow-purple-600/30"
              >
        ...
        <div className="flex-1 overflow-auto p-4 bg-zinc-950 font-mono text-xs leading-relaxed">
          <div className="space-y-0.5 border border-zinc-900 rounded-xl overflow-hidden">
